...
func (m *MockSecureSession) Encrypt(plaintext []byte) ([]byte, []byte, uint64, uint32, error) {
	return plaintext, nil, 1, 0, nil
}
func (m *MockSecureSession) Decrypt(ciphertext, remoteDHPubKey []byte, messageNumber uint64, previousChainLength uint32) ([]byte, error) {
